...
const FrankfurtCovid = ({ data }: { data: any }) => {
    ...
    return (
        <section id='covid' className={`${styles.covid} container`}>
            ...
            <div className={styles.covidContent}>
                ...
                {device === 'desktop' && (
                    <Link href={data?.seeAllURL} className={styles.covidContentSeeAll}>
            ...
            {device === 'mobile' && (
                <Link href={data?.seeAllURL} className={styles.covidContentSeeAllMobile}>
                    <p>{data?.description}</p>
                    <i className={`${styles.covidContentSeeAllIcon} arrow-right-icon`} />
                </Link>
            )}
